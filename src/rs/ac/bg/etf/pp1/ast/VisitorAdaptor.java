...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(CondFactMultiExpr CondFactMultiExpr) { visit(); }
    public void visit(CondFactSingleExpr CondFactSingleExpr) { visit(); }
    public void visit(CondTermMultiFacts CondTermMultiFacts) { visit(); }
    ...
    public void visit(DesignatorElemWithNamespace DesignatorElemWithNamespace) { visit(); }
    public void visit(DesignatorWithNamespace DesignatorWithNamespace) { visit(); }
    ...
    public void visit(CndNOStmts CndNOStmts) { visit(); }
    public void visit(CndMultipleStmts CndMultipleStmts) { visit(); }
    public void visit(CndSingleStmt CndSingleStmt) { visit(); }
    ...
    public void visit(StatementsBrackets StatementsBrackets) { visit(); }
    ...
    public void visit(MethodBasicTypeName MethodBasicTypeName) { visit(); }
